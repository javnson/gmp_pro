 ...
 * @brief SDPE project bindings for GMP CTL Portable for STM32.
 * @note SDPE-managed compile-time contract for the no-CSP STM32 CTL integration.
 */
...
#define GMP_CTL_PORTABLE_STM32_SDPE_PROJECT_ID "gmp_ctl_portable_stm32"
#define GMP_CTL_PORTABLE_STM32_SDPE_PROJECT_SUITE "ctl_portable"
#define GMP_CTL_PORTABLE_STM32_SDPE_PROJECT_VERSION "1.0.0"
#define GMP_CTL_PORTABLE_STM32_SDPE_PROJECT_UPDATED_AT "2026-08-11"
...
/**
 * @brief CTL real-time numeric backend. CMSIS-Q also requires CMSIS-DSP headers and library.
 *        Options: USING_FLOAT_FPU, USING_DOUBLE_FPU, USING_FIXED_ARM_CMSIS_Q_LIBRARY
 */
