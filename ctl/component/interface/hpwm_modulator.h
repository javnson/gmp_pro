                                                          ...
                                                          ctrl_gt inverter_current)
{
    ...
    ctrl_gt modulate_target_L = ctl_sat(ctl_div2(-u_target + CTL_CTRL_CONST_1), CTL_CTRL_CONST_1, 0);
    ctrl_gt modulate_target_N = ctl_sat(ctl_div2(u_target + CTL_CTRL_CONST_1), CTL_CTRL_CONST_1, 0);
