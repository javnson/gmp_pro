/**
 * @file    _controller_preset_template.h
...
#define MY_BOARD_NAME                 "Fill in your board name here, e.g., My Custom Board v2.1"
#define MY_BOARD_GATE_DRIVER_IC       "Fill in the gate driver IC model, e.g., DRV8301"
#define MY_BOARD_MOSFET_PART_NUMBER   "Fill in the MOSFET model, e.g., CSD18533Q5A"
#define MY_BOARD_CURRENT_SENSOR_MODEL "Fill in the current sensor/amplifier model, e.g., Shunt + OPA2374"
#define MY_BOARD_THERMAL_SENSOR_MODEL "Fill in the thermal sensor model, e.g., NTC 10k"
...
#define MY_BOARD_VBUS_MIN_V         (6.0f)  // Minimum DC bus operating voltage (V)
#define MY_BOARD_VBUS_MAX_V         (60.0f) // Maximum DC bus operating voltage (V)
#define MY_BOARD_CURRENT_MAX_RMS_A  (20.0f) // Maximum continuous phase current (RMS, A)
#define MY_BOARD_CURRENT_MAX_PEAK_A (35.0f) // Maximum allowed peak phase current (Peak, A)
...
#define MY_BOARD_PH_SHUNT_RESISTANCE_OHM (0.001f) // Resistance of the shunt resistor (Ohm)
#define MY_BOARD_PH_CSA_GAIN_V_V         (50.0f)  // Gain of the Current Sense Amplifier (CSA) (V/V)
...
#define MY_BOARD_PH_VOLTAGE_SENSE_GAIN                                                                                 \
    (0.0163f) // Gain of the voltage sensing circuit (V/V), i.e., (R_low / (R_high + R_low))
...
#define MY_BOARD_DCBUS_VOLTAGE_SENSE_GAIN    (0.0163f) // Gain of the voltage sensing circuit (V/V)
...
#define MY_BOARD_DCBUS_SHUNT_RESISTANCE_OHM  (0.001f)
#define MY_BOARD_DCBUS_CSA_GAIN_V_V          (50.0f)
