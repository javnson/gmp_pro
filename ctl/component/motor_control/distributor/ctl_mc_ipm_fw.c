 ...
 */
void ctl_autotuning_ipm_fixed_fw(ctl_ipm_fixed_fw_init_t* init)
{
    // -----------------------------------------------------------------
...
void ctl_init_ipm_fixed_fw(ctl_ipm_fixed_fw_t* dist, const ctl_ipm_fixed_fw_init_t* init)
{
