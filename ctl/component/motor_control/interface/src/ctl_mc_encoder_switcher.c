                             ...
                             parameter_gt isr_frequency_hz)
{
    ...
    ctx->spd_a = NULL;
    ctx->spd_b = NULL;
    ctx->out_enc.position = CTL_CTRL_CONST_ZERO;
    ctx->out_enc.elec_position = CTL_CTRL_CONST_ZERO;
    ctx->out_enc.revolutions = 0;
    ctx->out_spd.speed = CTL_CTRL_CONST_ZERO;
    ctx->state = ANGLE_SWITCH_IDLE_A;
    ctx->weight = CTL_CTRL_CONST_ZERO;
    ctx->transition_progress = CTL_CTRL_CONST_1;
    ctx->angle_offset_pu = CTL_CTRL_CONST_ZERO;
    ctx->transition_speed_start = CTL_CTRL_CONST_ZERO;
    ctx->speed_match_enter_pu = CTL_CTRL_CONST_ZERO;
    ctx->speed_match_exit_pu = CTL_CTRL_CONST_ZERO;
