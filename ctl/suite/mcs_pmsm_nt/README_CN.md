...
仓库当前包含以下目标目录：`f280039c_Iris_node`、`f280049c`、`f29h85x_lp_3phgan`、`simulate`、`stm32f405`、`stm32g431` 和 `stm32g474_hrtim`。F29H85x 目标要求 CCS 21 或更高版本，使用 `GMP-Core-C29x` Product，并通过两层 SDPE 分别绑定 LaunchPad 与 BOOSTXL-3PHGANINV 资源。新 PMSM 应用通常应从本套件开始，并保留公共 `src/` 与目标 `project/` 分层。
