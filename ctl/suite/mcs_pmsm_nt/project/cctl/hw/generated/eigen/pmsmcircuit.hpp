...
// Source SHA-256: 31645368dbff6961a63701e1748161cefa7b1ea9916ffa338b96dd07813b7a88
...
private:
    ...
    static std::shared_ptr<const ArchiveData> load_archive(
        ...
        constexpr std::array<std::uint8_t, 32U> expected_source_hash{{
            0x31U, 0x64U, 0x53U, 0x68U, 0xdbU, 0xffU, 0x69U, 0x61U, 0xa6U, 0x37U, 0x01U, 0xe1U, 0x74U, 0x81U, 0x61U, 0xceU, 0xfaU, 0x7bU, 0x1eU, 0xa9U, 0x91U, 0x6fU, 0xfaU, 0x33U, 0x8bU, 0x96U, 0xddU, 0x07U, 0x81U, 0x3bU, 0x7aU, 0x88U
        }};
