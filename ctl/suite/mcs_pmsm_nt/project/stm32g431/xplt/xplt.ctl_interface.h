...
void ctl_fast_enable_output()
{
    ...
    HAL_TIMEx_PWMN_Start(MCS_PWM_TIMER_HANDLE, TIM_CHANNEL_3);
		...
		// Enable Gate driver
		HAL_GPIO_WritePin(NUCLEO_G431RB_MOTOR_BOARD_GATE_ENABLE_PORT,
		                  NUCLEO_G431RB_MOTOR_BOARD_GATE_ENABLE_PIN, GPIO_PIN_SET);
...
//		__HAL_TIM_ENABLE(&htim1);
		...
		// Disable Gate Driver
		HAL_GPIO_WritePin(NUCLEO_G431RB_MOTOR_BOARD_GATE_ENABLE_PORT,
		                  NUCLEO_G431RB_MOTOR_BOARD_GATE_ENABLE_PIN, GPIO_PIN_RESET);
