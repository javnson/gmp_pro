/**
 * @file sdpe_pgs_sinv_2stage_common_settings.h
 * @brief SDPE project bindings for PGS Two-Stage Single-Phase Inverter Common Control.
 * @note Platform-independent control contract for the two-stage single-phase inverter simulation models.
 */

#ifndef _PROJECT_SDPE_PGS_SINV_2STAGE_COMMON_SETTINGS_H_
#define _PROJECT_SDPE_PGS_SINV_2STAGE_COMMON_SETTINGS_H_
...
#define PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_ID "pgs_sinv_2stage_common"
#define PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_SUITE "pgs_sinv_2stage"
#define PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_VERSION "1.0.0"
#define PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_UPDATED_AT "2026-08-15"
...
#endif // _PROJECT_SDPE_PGS_SINV_2STAGE_COMMON_SETTINGS_H_
