 ...
 * @brief SDPE project bindings for PGS Two-Stage SINV MATLAB/Simulink SIL.
 * @note Windows SIL platform, plant and sensing settings for the two-stage SINV simulation models.
 */
...
#define PGS_SINV_2STAGE_SIM_SDPE_PROJECT_ID "pgs_sinv_2stage_simulate"
#define PGS_SINV_2STAGE_SIM_SDPE_PROJECT_SUITE "pgs_sinv_2stage"
#define PGS_SINV_2STAGE_SIM_SDPE_PROJECT_VERSION "1.0.0"
#define PGS_SINV_2STAGE_SIM_SDPE_PROJECT_UPDATED_AT "2026-08-15"
...
//=================================================================================================
/**
 * @brief Common fallbacks: PGS Two-Stage Single-Phase Inverter Common Control.
 */
