function configure_sinv_2stage_models()
%CONFIGURE_SINV_2STAGE_MODELS Bind two-stage SINV plants to generated SDPE data.

root = fileparts(mfilename('fullpath'));
models = {'PGS_STD_SINV_2STAGE_MODEL_RLOAD', ...
          'PGS_STD_SINV_2STAGE_MODEL_Grid', ...
          'PGS_STD_SINV_2STAGE_MODEL_Rectifier'};
...
if getSimulinkBlockHandle(template) == -1
    load_system('PGS_STD_SINV_2STAGE_MODEL_RLOAD');
    template = 'PGS_STD_SINV_2STAGE_MODEL_RLOAD/Voltage Source1';
end
