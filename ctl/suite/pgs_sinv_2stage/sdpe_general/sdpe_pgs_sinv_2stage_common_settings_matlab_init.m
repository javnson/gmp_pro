...
% Project: PGS Two-Stage Single-Phase Inverter Common Control
...
% Notes:
%   Platform-independent control contract for the two-stage single-phase inverter simulation models.

%% Project metadata
PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_ID = 'pgs_sinv_2stage_common';

PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_SUITE = 'pgs_sinv_2stage';

PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_VERSION = '1.0.0';

PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_UPDATED_AT = '2026-08-15';
...
fprintf('\n============================================================\n');
fprintf('SDPE Project : %s\n', 'PGS Two-Stage Single-Phase Inverter Common Control');
fprintf('Project ID   : %s\n', 'pgs_sinv_2stage_common');
fprintf('Suite        : %s\n', 'pgs_sinv_2stage');
fprintf('Version      : %s\n', '1.0.0');
fprintf('Hardware (0):\n');
...
fprintf('  PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_ID = '); disp(PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_ID);
fprintf('  PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_SUITE = '); disp(PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_SUITE);
fprintf('  PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_UPDATED_AT = '); disp(PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_UPDATED_AT);
fprintf('  PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_VERSION = '); disp(PGS_SINV_2STAGE_COMMON_SDPE_PROJECT_VERSION);
