...
% Enable four PWM slots and all sixteen monitor slots used by the GFL SIL output ABI.
GMP_PIL_TX_MASK = 4294901775;

% ADC offset calibrator filter cutoff frequency.
GFL_ADC_CALIBRATOR_FC_HZ = real2param(20.0);

% ADC offset calibrator second-order filter quality factor.
GFL_ADC_CALIBRATOR_Q = real2param(0.707);
...
GFL_GRID_VOLTAGE_PU = real2param(0.33);

% P/Q outer-loop execution frequency in hertz.
GFL_PQ_LOOP_FREQUENCY_HZ = real2param(1000.0);
