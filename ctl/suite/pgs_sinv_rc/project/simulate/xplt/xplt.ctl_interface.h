...
GMP_STATIC_INLINE void ctl_output_callback(void)
{
    ...
    simulink_tx_buffer.monitor[0] = ctrl2param(adc_v_grid.control_port.value) * CTRL_VOLTAGE_BASE;
    simulink_tx_buffer.monitor[1] = ctrl2param(adc_i_ac.control_port.value) * CTRL_CURRENT_BASE;
    simulink_tx_buffer.monitor[2] = ctrl2param(adc_v_bus.control_port.value) * CTRL_VOLTAGE_BASE;
    simulink_tx_buffer.monitor[3] = ctrl2param(ref_gen.i_ref_inst) * CTRL_CURRENT_BASE;
    simulink_tx_buffer.monitor[4] = ctrl2param(rc_core.v_out_ref);
    simulink_tx_buffer.monitor[5] = ctrl2param(pll.frequency) * CTRL_GRID_FREQUENCY;
    simulink_tx_buffer.monitor[6] = ctrl2param(pq_meter.active_power_p);
    simulink_tx_buffer.monitor[7] = ctrl2param(pq_meter.reactive_power_q);
    simulink_tx_buffer.monitor[8] = ctrl2param(rc_core.current_error);
    simulink_tx_buffer.monitor[9] = ctrl2param(rc_core.u_qpr);
    simulink_tx_buffer.monitor[10] = ctrl2param(rc_core.u_fdrc);
    ...
    simulink_tx_buffer.monitor[15] = ctrl2param(protection.node_ctrl_diverge.fault_record_val);
