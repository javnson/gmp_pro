...
| --- | --- | --- | ---: | --- |
| `project/simulate/PGS_STD_SINV_MODEL_Grid.slx` | model | PASS | 27 | PASS |
| `project/simulate/PGS_STD_SINV_MODEL_Grid_2022b.slx` | model | PASS | 21 | PASS |
| `project/simulate/PGS_STD_SINV_MODEL_Rectifier.slx` | model | PASS | 27 | PASS |
| `project/simulate/PGS_STD_SINV_MODEL_Rectifier_2022b.slx` | model | PASS | 21 | PASS |
| `project/simulate/PGS_STD_SINV_MODEL_RLOAD.slx` | model | PASS | 27 | PASS |
| `project/simulate/PGS_STD_SINV_MODEL_RLOAD_2022b.slx` | model | PASS | 21 | PASS |

## Per-model evidence

### `project/simulate/PGS_STD_SINV_MODEL_Grid.slx`
...
### `project/simulate/PGS_STD_SINV_MODEL_Grid_2022b.slx`

Referenced generated SDPE variables: `CTRL_AC_CURRENT_BIAS`, `CTRL_AC_CURRENT_SENSITIVITY`, `CTRL_AC_INDUCTANCE`, `CTRL_AC_RESISTANCE`, `CTRL_AC_VOLTAGE_BIAS`, `CTRL_AC_VOLTAGE_SENSITIVITY`, `CTRL_ADC_RESOLUTION`, `CTRL_ADC_VOLTAGE_REF`, `CTRL_DCBUS_VOLTAGE`, `CTRL_DC_VOLTAGE_BIAS`, `CTRL_DC_VOLTAGE_SENSITIVITY`, `CTRL_GRID_VOLTAGE_RMS`, `CTRL_PWM_CMP_MAX`, `CTRL_PWM_DEADBAND_CMP`, `SINV_DC_CAPACITANCE_F`, `SINV_FILTER_CAPACITANCE_F`, `SINV_FILTER_CAP_ESR_OHM`, `SINV_MODEL_DIODE_RON`, `SINV_MODEL_DIODE_VF`, `SINV_MODEL_MOSFET_RON`, `SINV_PWM_FREQUENCY_HZ`.

Numeric physical-parameter candidates: `Amplitude=0`, `Capacitance=1e-6`, `Frequency=0`, `Frequency=2*pi*CTRL_GRID_FREQUENCY`, `Gain=2^ADC_BIT`, `Inductance=10e-6`, `Inductance=1e-3`, `Resistance=1`.

### `project/simulate/PGS_STD_SINV_MODEL_Rectifier.slx`
...
### `project/simulate/PGS_STD_SINV_MODEL_Rectifier_2022b.slx`

Referenced generated SDPE variables: `CTRL_AC_CURRENT_BIAS`, `CTRL_AC_CURRENT_SENSITIVITY`, `CTRL_AC_INDUCTANCE`, `CTRL_AC_RESISTANCE`, `CTRL_AC_VOLTAGE_BIAS`, `CTRL_AC_VOLTAGE_SENSITIVITY`, `CTRL_ADC_RESOLUTION`, `CTRL_ADC_VOLTAGE_REF`, `CTRL_DC_VOLTAGE_BIAS`, `CTRL_DC_VOLTAGE_SENSITIVITY`, `CTRL_GRID_VOLTAGE_RMS`, `CTRL_PWM_CMP_MAX`, `CTRL_PWM_DEADBAND_CMP`, `SINV_DC_CAPACITANCE_F`, `SINV_FILTER_CAPACITANCE_F`, `SINV_FILTER_CAP_ESR_OHM`, `SINV_MODEL_DIODE_RON`, `SINV_MODEL_DIODE_VF`, `SINV_MODEL_MOSFET_RON`, `SINV_PWM_FREQUENCY_HZ`, `SINV_RECTIFIER_RLOAD_OHM`.

Numeric physical-parameter candidates: `Amplitude=0`, `Capacitance=1e-6`, `Frequency=0`, `Frequency=2*pi*CTRL_GRID_FREQUENCY`, `Gain=2^ADC_BIT`, `Inductance=10e-6`, `Inductance=1e-3`.

### `project/simulate/PGS_STD_SINV_MODEL_RLOAD.slx`
...
### `project/simulate/PGS_STD_SINV_MODEL_RLOAD_2022b.slx`

Referenced generated SDPE variables: `CTRL_AC_CURRENT_BIAS`, `CTRL_AC_CURRENT_SENSITIVITY`, `CTRL_AC_INDUCTANCE`, `CTRL_AC_RESISTANCE`, `CTRL_AC_VOLTAGE_BIAS`, `CTRL_AC_VOLTAGE_SENSITIVITY`, `CTRL_ADC_RESOLUTION`, `CTRL_ADC_VOLTAGE_REF`, `CTRL_DCBUS_VOLTAGE`, `CTRL_DC_VOLTAGE_BIAS`, `CTRL_DC_VOLTAGE_SENSITIVITY`, `CTRL_PWM_CMP_MAX`, `CTRL_PWM_DEADBAND_CMP`, `SINV_DC_CAPACITANCE_F`, `SINV_FILTER_CAPACITANCE_F`, `SINV_FILTER_CAP_ESR_OHM`, `SINV_MODEL_DIODE_RON`, `SINV_MODEL_DIODE_VF`, `SINV_MODEL_MOSFET_RON`, `SINV_PWM_FREQUENCY_HZ`, `SINV_RLOAD_OHM`.
