...
from datalink_panel import DataLinkPanel
...
class ResultViewer(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.datalink_panel = DataLinkPanel(self.simulation, self)
        self.view_tabs.addTab(self.datalink_panel, "Data Link")
