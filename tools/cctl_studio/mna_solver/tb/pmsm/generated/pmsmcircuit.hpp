...
public:
    ...
    static constexpr std::size_t state_vector_count = 1209;
    ...
    const Outputs& step_short(std::uint32_t PWM1, std::uint32_t PWM2, std::uint32_t PWM3, std::uint32_t PWM4, std::uint32_t PWM5, std::uint32_t PWM6, double IPMSM1_C, double IPMSM1_B, double IPMSM1_A, double VS1) {
        return step_short(Inputs{PWM1, PWM2, PWM3, PWM4, PWM5, PWM6, IPMSM1_C, IPMSM1_B, IPMSM1_A, VS1});
    }

    const Outputs& step_normal(std::uint32_t PWM1, std::uint32_t PWM2, std::uint32_t PWM3, std::uint32_t PWM4, std::uint32_t PWM5, std::uint32_t PWM6, double IPMSM1_C, double IPMSM1_B, double IPMSM1_A, double VS1) {
        return step_normal(Inputs{PWM1, PWM2, PWM3, PWM4, PWM5, PWM6, IPMSM1_C, IPMSM1_B, IPMSM1_A, VS1});
    }

    const Outputs& run(std::uint32_t PWM1, std::uint32_t PWM2, std::uint32_t PWM3, std::uint32_t PWM4, std::uint32_t PWM5, std::uint32_t PWM6, double IPMSM1_C, double IPMSM1_B, double IPMSM1_A, double VS1) {
        return step_normal(PWM1, PWM2, PWM3, PWM4, PWM5, PWM6, IPMSM1_C, IPMSM1_B, IPMSM1_A, VS1);
    }

    const Outputs& operator()(std::uint32_t PWM1, std::uint32_t PWM2, std::uint32_t PWM3, std::uint32_t PWM4, std::uint32_t PWM5, std::uint32_t PWM6, double IPMSM1_C, double IPMSM1_B, double IPMSM1_A, double VS1) {
        return run(PWM1, PWM2, PWM3, PWM4, PWM5, PWM6, IPMSM1_C, IPMSM1_B, IPMSM1_A, VS1);
    }
...
private:
    ...
    using InputMatrix = Eigen::Matrix<double, 4, 4>;
    using StateVector = Eigen::Matrix<double, 4, 1>;
    using SignalMatrix = Eigen::Matrix<double, 18, 4>;
    using SignalInputMatrix = Eigen::Matrix<double, 18, 4>;
    ...
    const Outputs& step(const Inputs& inputs, bool use_short_step) {
        ...
        output.VPMSM1_A = signals_(3);
        output.VPMSM1_B = signals_(4);
        output.VPMSM1_C = signals_(5);
        return output;
    }
