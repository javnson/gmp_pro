...
// Generated by GMP mna_solver/cpp_codegen.py from SINV.CIR.
// Source SHA-256: 6572890118b008b55f974d1872c65b319235aff98965c5a9958ba2cd34008db2
...
public:
    ...
    static constexpr const char* archive_filename = "sinvcircuit.archive";
    static constexpr std::size_t state_matrix_count = 162;
    static constexpr std::size_t input_matrix_count = 156;
    static constexpr std::size_t state_vector_count = 127;
    ...
    struct Outputs {
        ...
        double operator[](std::string_view name) const {
            ...
            if (name == "V(2,1)" || name == "n_2") return n_2;
...
private:
    ...
    static std::shared_ptr<const ArchiveData> load_archive(
        ...
        constexpr std::array<std::uint8_t, 32U> expected_source_hash{{
            0x4fU, 0xaeU, 0x54U, 0xfbU, 0x97U, 0x6cU, 0xcdU, 0x13U, 0x27U, 0x7eU, 0x7bU, 0xd8U, 0x7bU, 0xc4U, 0x07U, 0x00U, 0x9eU, 0x56U, 0xb1U, 0xc6U, 0x0bU, 0x5fU, 0x9fU, 0xd8U, 0x1cU, 0x85U, 0x8bU, 0x05U, 0xf8U, 0x4bU, 0x56U, 0xeaU
        }};
