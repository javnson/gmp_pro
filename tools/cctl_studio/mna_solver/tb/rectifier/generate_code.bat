...
set "NETLIST_FILE=RECTIFIER.CIR"
...
python "%MNA_TOOL_DIR%\circuit_data.py" export "%NETLIST_PATH%" "%JSON_PATH%" --normal-dt 1U --short-dt 10N --method "%DISCRETIZATION_METHOD%" --matrix-tolerance "%MATRIX_TOLERANCE%"
if errorlevel 1 goto :failed
