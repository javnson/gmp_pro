...
struct configuration
{
    ...
    bool startup_timeout_enabled = true;                       //!< False waits for first peer data until abort().
    std::uint64_t established_after_frames = protocol::startup_qualification_frames; //!< Valid frames before long timeout.
...
class asio_tcp_helper
{
  public:
    ...
    void accept()
    {
        ...
        run_timed_control(
            ...
            config_.connect_timeout, config_.startup_timeout_enabled, "TCP accept");
    ...
    void connect()
    {
        ...
        run_timed_control(
            ...
            [this]() { close_socket_noexcept(); }, config_.connect_timeout,
            config_.startup_timeout_enabled, "TCP connect");
        configure_connected_socket();
    }
    ...
    [[nodiscard]] bool effective_io_timeout_enabled() const noexcept
    {
        return established_timeout_active() || config_.startup_timeout_enabled;
    }
  ...
  private:
    ...
    std::size_t run_timed_io(StartOperation start_operation, CancelOperation cancel_operation,
                             std::chrono::milliseconds timeout, bool timeout_enabled,
    ...
    void send_unlocked(const frame& outgoing)
    {
        ...
        run_timed_io(
            ...
            effective_io_timeout(), effective_io_timeout_enabled(), "TCP write");
    }
    ...
    frame receive_unlocked()
    {
        ...
        run_timed_io(
            ...
            effective_io_timeout(), effective_io_timeout_enabled(), "TCP header read");
        ...
        if (!incoming.payload.empty())
        {
            run_timed_io(
                ...
                effective_io_timeout(), effective_io_timeout_enabled(), "TCP payload read");
        }
