...
#ifndef _FILE_GMP_DATALINK_U16_H
#define _FILE_GMP_DATALINK_U16_H
...
/**
 * @brief Mark the current receive frame as handled by the application.
 * @details The default response policy skips handled frames to prevent a
 * duplicate response.
 * @param  ctx Pointer to the datalink context.
 */
...
#endif // _FILE_GMP_DATALINK_U16_H
