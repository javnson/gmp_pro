...
#if SPECIFY_GMP_LOGO_MODE != GMP_LOGO_MODE_DISABLED
// This function would print a GMP label
void gmp_base_show_label(void)
{

#if SPECIFY_GMP_LOGO_MODE == GMP_LOGO_MODE_LITE
#include <core/rt/gmp_logo_lite.inl>
#else
#include <core/rt/gmp_logo.inl>
#endif

    gmp_base_print(TEXT_STRING("[okay] General motor platform ready.\r\n"));
}
#endif // SPECIFY_GMP_LOGO_MODE != GMP_LOGO_MODE_DISABLED
...
ec_gt gmp_hal_uart_send(GMP_BASE_PRINT_DEFAULT_HANDLE_TYPE placeholder1,
                        gmp_print_buffer_t *placeholder2) GMP_WEAK_FUNC_SUFFIX
{
    // not implement
    return 0;
}
