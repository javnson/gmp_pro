 ...
 *
 */
void ctl_discrete_quasi_resonant_Start_wrapper(real_T *xD,
			void **pW,
...
// pr_param[0]:  kr
    ...
    ctl_init_qr_controller(ctrl, pr_param[0], pr_param[1], pr_param[2], *ctrl_freq);
 ...
 *
 */
void ctl_discrete_quasi_resonant_Outputs_wrapper(real_T *y0,
			const real_T *xD,
			void **pW,
			const real_T *pr_param, const int_T p_width0,
			const real_T *ctrl_freq, const int_T p_width1,
 ...
 *
 */
void ctl_discrete_quasi_resonant_Update_wrapper(const real_T *u0,
			real_T *y0,
			real_T *xD,
			void **pW,
			const real_T *pr_param, const int_T p_width0,
 ...
 *
 */
void ctl_discrete_quasi_resonant_Terminate_wrapper(real_T *xD,
			void **pW,
			const real_T *pr_param, const int_T p_width0,
			const real_T *ctrl_freq, const int_T p_width1,
			SimStruct *S)
