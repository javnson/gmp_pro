function tests = test_ctl_simulink_components
...
if bdIsLoaded('ctl_simulink_components'), close_system('ctl_simulink_components', 0); end
end

function testGeneratedLibraryAndTabbedMasks(testCase)
blocks = find_system('ctl_simulink_components', 'BlockType', 'S-Function');
...
for index = 1:numel(blocks)
    verifyEqual(testCase, get_param(blocks{index}, 'MaskType'), 'CTL Simulink Components');
