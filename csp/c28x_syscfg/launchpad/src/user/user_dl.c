/**
 * @file user_dl.c
 * @brief Data Link composition for the portable LaunchPad reference app.
 */
...
#error "The LaunchPad validation firmware requires the u16 Data Link backend"
#endif
...
#pragma DATA_SECTION(dl_scope_storage, "mass_data")
#endif
