 ...
 * @brief SDPE project bindings for LAUNCHXL-F280039C GMP application bindings.
...
#include "hardware_preset/mcu_board/launchxl_f280039c.h"
...
#define LAUNCHXL_F280039C_SDPE_PROJECT_ID "gmp_launchpad_f280039c_bindings"
#define LAUNCHXL_F280039C_SDPE_PROJECT_SUITE "c28x_syscfg_launchpad"
#define LAUNCHXL_F280039C_SDPE_PROJECT_VERSION "0.2.0"
#define LAUNCHXL_F280039C_SDPE_PROJECT_UPDATED_AT "2026-08-16"
 ...
 *        Options: BOOSTXL_ADC23_SELECT, BOOSTXL_ADC24_SELECT, BOOSTXL_ADC29_SELECT, BOOSTXL_ADC46_SELECT, BOOSTXL_ADC65_SELECT, BOOSTXL_ADC69_SELECT, BOOSTXL_ADC2_SELECT, BOOSTXL_ADC6_SELECT, BOOSTXL_ADC26_SELECT, BOOSTXL_ADC63_SELECT, BOOSTXL_ADC66_SELECT, BOOSTXL_ADC68_SELECT, BOOSTXL_ADC25_SELECT, BOOSTXL_ADC27_SELECT, BOOSTXL_ADC28_SELECT, BOOSTXL_ADC42_SELECT, BOOSTXL_ADC64_SELECT, BOOSTXL_ADC67_SELECT
 */
 ...
 */
#define LAUNCHPAD_BOARD_NAME LAUNCHXL_F280039C_BOARD_NAME

/**
 * @brief Board LED used by the scheduler heartbeat.
 */
#define LAUNCHPAD_USER_LED_GPIO LAUNCHXL_F280039C_USER_LED_GPIO

/**
 * @brief Compile-time device DAC capability.
 */
#define LAUNCHPAD_HAS_EXTERNAL_DAC LAUNCHXL_F280039C_HAS_EXTERNAL_DAC

/**
 * @brief Classic CAN service selection.
 */
#define LAUNCHPAD_CAN_CLASSIC LAUNCHXL_F280039C_CAN_CLASSIC

/**
 * @brief MCAN service selection.
 */
#define LAUNCHPAD_CAN_MCAN LAUNCHXL_F280039C_CAN_MCAN

/**
 * @brief Selected CAN or MCAN base.
 */
#define LAUNCHPAD_CAN_BASE LAUNCHXL_F280039C_CAN_BASE
