...
SECTIONS
{
   .freertosStaticStack : > RAMLS4567
   .freertosHeap        : > RAMGS0
   codestart        : > BEGIN, ALIGN(8)
   /* The GMP/Data Link reference is larger than TI's small example image.
    * Keep SEC1 for C initialization and constants, then allow executable code
    * to span the remaining Flash bank without changing the boot entry. */
   .text            : >> FLASH_BANK0_SEC2 | FLASH_BANK0_SEC3 | FLASH_BANK0_SEC4 |
                         ...
                         FLASH_BANK0_SEC14 | FLASH_BANK0_SEC15, ALIGN(8)
