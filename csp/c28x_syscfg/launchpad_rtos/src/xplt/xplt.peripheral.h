...
/** @brief Start the ePWM-triggered ADC control interrupt. */
void xplt_start_sample_timer(void);

/** @brief Mask application interrupts before the FreeRTOS scheduler starts. */
void xplt_rtos_pre_scheduler(void);

/** @brief Enable application interrupts after GMP initialization completes. */
void xplt_rtos_activate(void);
