...
function printState(cpu1, cpu2, cm, phase)
{
    ...
    readExpression(cpu2, "CPU2 wave samples", "'cpu2_app.c'::wave_sample_count");
    ...
    readExpression(cm, "CM DL TX state", "'cm_app.c'::cm_datalink.tx_state");
    readExpression(cm, "CM DL RX state", "'cm_app.c'::cm_datalink.rx_state");
    readExpression(cm, "CM DL RX FIFO overflows", "'cm_app.c'::cm_datalink.err_fifo_ovf_cnt");
    readExpression(cm, "CM DL header CRC errors", "'cm_app.c'::cm_datalink.err_hdr_crc_cnt");
    readExpression(cm, "CM DL payload CRC errors", "'cm_app.c'::cm_datalink.err_pld_crc_cnt");
    readExpression(cm, "CM scope state", "'cm_app.c'::cm_scope.state");
    readExpression(cm, "CM scope generation", "'cm_app.c'::cm_scope.generation");
    readExpression(cm, "CM scope history count", "'cm_app.c'::cm_scope.history_count");
    ...
    readExpression(cm, "TCP listener", "'cm_app.c'::cm_tcp_listener");
    readExpression(cm, "TCP client", "'cm_app.c'::cm_tcp_client");
    readExpression(cm, "TCP send buffer", "'cm_app.c'::cm_tcp_client == 0 ? 0 : 'cm_app.c'::cm_tcp_client->snd_buf");
    readExpression(cm, "TCP queued segments", "'cm_app.c'::cm_tcp_client == 0 ? 0 : 'cm_app.c'::cm_tcp_client->snd_queuelen");
