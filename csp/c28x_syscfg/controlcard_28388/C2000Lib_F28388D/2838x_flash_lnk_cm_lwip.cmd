MEMORY
{
   ...
   CPU1TOCMMSGRAM0_SYS : origin = 0x20080000, length = 0x00000200
   CPU1TOCMMSGRAM0_APP : origin = 0x20080200, length = 0x00000600
   CPU1TOCMMSGRAM1  : origin = 0x20080800, length = 0x00000800
   CMTOCPU1MSGRAM0_SYS : origin = 0x20082000, length = 0x00000200
   CMTOCPU1MSGRAM0_APP : origin = 0x20082200, length = 0x00000600
   CMTOCPU1MSGRAM1  : origin = 0x20082800, length = 0x00000800
   CPU2TOCMMSGRAM0_SYS : origin = 0x20084000, length = 0x00000200
   CPU2TOCMMSGRAM0_APP : origin = 0x20084200, length = 0x00000600
   CPU2TOCMMSGRAM1  : origin = 0x20084800, length = 0x00000800
   CMTOCPU2MSGRAM0_SYS : origin = 0x20086000, length = 0x00000200
   CMTOCPU2MSGRAM0_APP : origin = 0x20086200, length = 0x00000600
...
SECTIONS
{
   ...
   .const           : {} LOAD = CMBANK0_SECTOR0 | CMBANK0_SECTOR1 ,
    ...
    MSGRAM_CM_TO_CPU1 : > CMTOCPU1MSGRAM0_SYS, type=NOINIT
    MSGRAM_CM_TO_CPU2 : > CMTOCPU2MSGRAM0_SYS, type=NOINIT
    MSGRAM_CPU1_TO_CM : > CPU1TOCMMSGRAM0_SYS, type=NOINIT
    MSGRAM_CPU2_TO_CM : > CPU2TOCMMSGRAM0_SYS, type=NOINIT
    GMP_MSGRAM_CM_TO_CPU1 : > CMTOCPU1MSGRAM0_APP, type=NOINIT
    GMP_MSGRAM_CM_TO_CPU2 : > CMTOCPU2MSGRAM0_APP, type=NOINIT
    GMP_MSGRAM_CPU1_TO_CM : > CPU1TOCMMSGRAM0_APP, type=NOINIT
    GMP_MSGRAM_CPU2_TO_CM : > CPU2TOCMMSGRAM0_APP, type=NOINIT
