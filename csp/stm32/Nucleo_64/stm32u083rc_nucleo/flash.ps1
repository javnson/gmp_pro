...
param(
    ...
    [string]$Image = (Join-Path $PSScriptRoot "build\release\stm32u083rc_nucleo.hex")
)
$ErrorActionPreference = "Stop"
if (-not (Test-Path -LiteralPath $Programmer)) { throw "STM32CubeProgrammer CLI not found: $Programmer" }
