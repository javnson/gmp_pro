/**
 * @file ctl_main.h
 * @brief Safe bring-up controller for the shared Nucleo-144 platform.
 */

#ifndef GMP_STM32_NUCLEO_144_CTL_MAIN_H
#define GMP_STM32_NUCLEO_144_CTL_MAIN_H
...
#endif // GMP_STM32_NUCLEO_144_CTL_MAIN_H
