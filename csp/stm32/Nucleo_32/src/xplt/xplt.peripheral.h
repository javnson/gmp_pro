/** @file xplt.peripheral.h Shared STM32 Nucleo-32 peripheral services. */

#ifndef GMP_STM32_NUCLEO_32_XPLT_PERIPHERAL_H
#define GMP_STM32_NUCLEO_32_XPLT_PERIPHERAL_H
...
#endif // GMP_STM32_NUCLEO_32_XPLT_PERIPHERAL_H
