/**
 * @file xplt.config.h
 * @brief Shared GMP configuration for STM32 Nucleo-32 control targets.
 */

#ifndef GMP_STM32_NUCLEO_32_XPLT_CONFIG_H
#define GMP_STM32_NUCLEO_32_XPLT_CONFIG_H
...
#endif // GMP_STM32_NUCLEO_32_XPLT_CONFIG_H
